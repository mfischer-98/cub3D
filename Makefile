...
#    Updated: 2026/06/02 10:43:53 by mefische         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = src/main.c src/init.c src/events.c src/free_data.c src/draw_pixels.c src/movements.c src/ray.c src/debug_tools.c \
