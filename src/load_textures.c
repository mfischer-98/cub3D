...
void	get_buffers(t_textures *textures)
{
	textures->n_wall.buffer = mlx_get_data_addr(textures->n_wall.img,
		&textures->n_wall.bpp, &textures->n_wall.line_length, &textures->n_wall.endian);
	textures->s_wall.buffer = mlx_get_data_addr(textures->s_wall.img,
		&textures->s_wall.bpp, &textures->s_wall.line_length, &textures->s_wall.endian);
	textures->e_wall.buffer = mlx_get_data_addr(textures->e_wall.img,
		&textures->e_wall.bpp, &textures->e_wall.line_length, &textures->e_wall.endian);
	textures->w_wall.buffer = mlx_get_data_addr(textures->w_wall.img,
		&textures->w_wall.bpp, &textures->w_wall.line_length, &textures->w_wall.endian);
}
